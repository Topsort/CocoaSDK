...
public struct ClickEvent: Codable, JSONEncodable, Hashable {
    ...
    public init(eventType: EventType, session: Session, placement: Placement, productId: String? = nil, auctionId: String? = nil, id: String? = nil, occurredAt: Date? = nil, resolvedBidId: String? = nil) {
